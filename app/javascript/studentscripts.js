  ...
  $('.enablecalendar').click(function(){
     ...
     console.log("GOT HERE AT app/javascript/studentscripts.js !!!!!!!!!!!!!!!!!!!!!!!!!!!!");
...
//         }
  ...
  $('.enabletest').click(function(){
     console.log("GOT HERE ENABLE TEST app/assets/javascript/studentscripts.js !!!!!!!!!!!!!!!!!!!!!!!!!!!!");
  });
...
//   THIS IS FROM app/javascript/studentscripts.js
